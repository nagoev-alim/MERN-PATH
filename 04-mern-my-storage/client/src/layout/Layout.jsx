...
import { FaCheck, FaHouseUser, FaSignInAlt, FaSignOutAlt, FaUser, FaUserCog, SlNotebook } from 'react-icons/all.js';
import { useDispatch, useSelector } from 'react-redux';
/* =============================
📦 Custom Imports
============================= */
import { logout, userSelector } from '@features/user/userSlice.js';
import { setCategory } from '@features/category/categorySlice.js';
/* =============================
📦 Component - Layout
============================= */
  ...
  return <div className='layout'>
    ...
    <header className='header'>
      <Link className='logo' to='/'>
        <SlNotebook size={20} /> MyStorageNotes
      </Link>
